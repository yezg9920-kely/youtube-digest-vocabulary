...
var YTD_SETTINGS = (() => {
    ...
    return {
      ...
      supadataApiKey:
        typeof input.supadataApiKey === "string"
          ...
          : "",
      autoBasicOverview: input.autoBasicOverview === true,
    };
  }
  ...
  function mergeProviderSettings(current, provider, apiKey, options = {}) {
    ...
    if (provider === "supadata") {
      next.supadataApiKey = normalizedKey;
      return next;
    }
    if (provider === "deepseek") {
      next.aiApiKey = normalizedKey;
      const consent = options && typeof options === "object"
        ? Object.getOwnPropertyDescriptor(options, "autoBasicOverview")?.value
        : undefined;
      if (typeof consent === "boolean") {
        next.autoBasicOverview = consent;
      }
      return next;
    }
